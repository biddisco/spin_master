...
function(add_subproject name)
  ...
  if(SUBPROJECT_${name})
    ...
    if(NOT ${name}_DIR)
      set(${name}_DIR 
        "${CMAKE_BINARY_DIR}/${name}" CACHE PATH
        "Location of ${name} project" FORCE)
    endif()
    set(CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH} "${CMAKE_BINARY_DIR}/${name}/lib/cmake/${name}" PARENT_SCOPE)
#    list(APPEND CMAKE_PREFIX_PATH "${CMAKE_BINARY_DIR}/${name}/lib/cmake/${name}" PARENT_SCOPE)
